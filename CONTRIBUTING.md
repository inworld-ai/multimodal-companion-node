# Contributing to Multimodal Companion

Thank you for your interest in contributing to the Multimodal Companion! This document provides guidelines and instructions for contributing.
...
2. **Clone your fork**:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/multimodal-companion-node.git
...
- **GitHub Issues**: [Open an issue](https://github.com/inworld/multimodal-companion-node/issues)
